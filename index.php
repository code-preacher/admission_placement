                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            ...
                            <span class="brand-logo">ADMISSION PLACEMENT SYSTEM</span>
                        </a>
                    </div>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="fill" style="background-image:url('images/a1.jpg');"></div>
                        <div class="carousel-caption">
                            <h1 class="wow animated bounceInDown" style="font-family: monotype corsiva;">Welcome to Admission Placement System! </h1>
             <p class="intro-text wow animated bounceInLeft" style="font-family: monotype corsiva;font-size: 25px;"> </p>
              <p class="intro-text wow animated bounceInUp"></p>
                            <a href="main.php" class="btn btn-default btn-lg">Get Started</a>
                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="fill" style="background-image:url('images/e9.jpg');"></div>
                        <div class="carousel-caption">
                                <h2 class="wow animated bounceInDown" style="font-family: monotype corsiva;color: #fff;">Get information of tertiary institutions you will like to attend</h2>
             <p class="intro-text wow animated slideInUp" style="font-family: monotype corsiva;font-size: 25px;"> </p>
                             <a href="main.php" class="btn btn-default btn-lg">Get Started</a>
                        </div>
                        <div class="overlay-detail"></div>
                    </div><!-- /.item -->
